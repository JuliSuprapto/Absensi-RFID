...
//WIFI SETTING
char wifi_ssid[34] = "UBL Mekatronik";
char wifi_password[34] = "foline12421025";
...
#define RST_PIN 5  // RST-PIN für RC522 - RFID - SPI - Modul GPIO5 
#define SS_PIN 4  // SDA-PIN für RC522 - RFID - SPI - Modul GPIO4 
#define BUZZER 0 // pcb merah (D3) (kalau hijau, biru D8) 
#define LED1 15 // pcb merah (kalau hijau,biru d4)
#define LED2 2
